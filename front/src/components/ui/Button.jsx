...
export function Button({ variant = 'ghost', size = 'md', className, children, ...props }) {
  const v = {
    primary: 'bg-orange-500 text-on-accent hover:bg-orange-600 font-semibold shadow-[0_8px_20px_-8px_rgba(234,88,12,.55)] disabled:bg-stone-100 disabled:text-stone-500 disabled:shadow-none',
